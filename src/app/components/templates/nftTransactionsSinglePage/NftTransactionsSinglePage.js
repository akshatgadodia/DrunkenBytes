    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="View details of your single NFT transaction on Drunken Bytes transaction page. Get real-time updates and keep track of your NFT transactions."
        />
        <meta property="og:image" content="https://drunkenbytes.vercel.app/images/page-shots/nft-transaction.png" />
        <meta name="twitter:title" content="NFT Transaction | Drunken Bytes" />
        <meta
          name="twitter:description"
          content="View details of your single NFT transaction on Drunken Bytes transaction page. Get real-time updates and keep track of your NFT transactions."
        />
        <meta name="twitter:image" content="https://drunkenbytes.vercel.app/images/page-shots/nft-transaction.png" />
        <link
          rel="canonical"
